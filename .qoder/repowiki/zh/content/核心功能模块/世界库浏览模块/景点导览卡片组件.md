...
## 更新摘要
**所做更改**
- 新增博尔盖塞别墅POI的完整支持，包括数据结构和图片映射
- 更新了图片资源管理部分，说明新增的罗马景点配图
- 增强了POI数据模型示例，展示公园类型景点的数据结构
- 完善了故障排查指南，包含新增POI的相关检查项
...
章节来源
- [PoiGuideCard.tsx:223-253](file://src/features/world/PoiGuideCard.tsx#L223-L253)
- [schema.ts:192-200](file://src/domain/world/schema.ts#L192-L200)
